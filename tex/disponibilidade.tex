...
Eles servem como uma técnica de tolerância a falhas e tem como função a
...
\section{Cálculo de tolerância a falhas}

Esses mecanismos têm que como consequência um sistema que opera
...
Organizações que trabalham com serviços web priorizam o máximo do tempo online e buscam
...
Conforme Ribeiro \cite{escalabilidade-de-aplicacoes-web}, utilizar a técnica de possuir várias
instâncias de servidores executando uma aplicação leve, ao invés do contrário, permite
que seja possível deixar elástica a infraestrutura -
aumentando e diminuindo de acordo com a necessidade.
