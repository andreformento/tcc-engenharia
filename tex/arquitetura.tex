...
\begin{figure}
  \centering
    \scalebox{1}
    {
        \begin{sequencediagram}
            \newthread{A}{\shortstack{Cliente\\ \\\begin{tikzpicture}
                                                  \node [copy shadow,fill=gray!20,draw=black,thick ,align=center] {Mobile \\ Web site};
                                                  \end{tikzpicture}}}{}
                \newinst[1]{B}{\shortstack{API \\ Gateway \\ \\ \begin{tikzpicture}
            \node [fill=gray!20,draw=black,thick ,align=center] {Balanceador de cargas};
            \end{tikzpicture}}}{}
                \newinst[1]{C}{\shortstack{Serviço \\  de reservas \\ \\\begin{tikzpicture}[shape aspect=.5]
            \tikzset{every node/.style={cylinder, shape border rotate=90, draw,fill=gray!25}}
            \node  at (1.5,0) {BD};
            \end{tikzpicture}}}{}
                \begin{call}{A}{chama}{B}{}
                \end{call}
                \begin{call}{B}{}{C}{}
                \end{call}
        \end{sequencediagram}
